...
export const Register = ({ className }: RegisterProps) => {
    ...
    const [inputs, setInputs] = useState({
      ...
      const handleSubmit = async (e: { preventDefault: () => void }) => {
        e.preventDefault();
        try {
          const res = await axios.post("https://fbapi-668309e6ed75.herokuapp.com/api/auth/register", inputs);
          console.log(res);
        } catch (err: any) {
      ...
      const handleGoogleLogin = async (
        ...
        try {
          ...
          if (user && user.email) {
            ...
            const response = await axios.post("https://fbapi-668309e6ed75.herokuapp.com/api/auth/register", userData);
