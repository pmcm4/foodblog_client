                ...
                <div className={styles.firstrow}>
                    <div className={styles.pics}>
                        <div className={styles.pic}>
                            <img
                                src="https://res.cloudinary.com/dgb2lnz2i/image/upload/v1684517157/346141284_858769632418487_3439762911420222881_n_uei3mv.png"
                        ...
                        <div className={styles.pic}>
                            <img
                                src="https://res.cloudinary.com/dgb2lnz2i/image/upload/v1684517444/MORATO_PAOLO_MIGUEL_C._1_mebp1h.jpg"
                                className={styles.image2}
                            />
                        </div>
                    </div>
                    <div className={styles.names}>
                        <h1 className={styles.name}>Justin Salvador</h1>
